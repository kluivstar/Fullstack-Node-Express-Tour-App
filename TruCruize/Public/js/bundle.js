...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */ // A promise-based HTTP client for making requests.
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            ...
            data: {
              // Sends a POST request using Axios with the provided credentials.
              email: email,
              password: password
            }
          });
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieHh4ZXJzIiwiYSI6ImNtN2I4MWxvZjBhcXMybXM5bjl0Ym9wajMifQ.63hQO4i1tZdY_Pyf7uo9Wg';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          url = type === 'password' ? 'http://127.0.0.1:3000/users/updatePassword' : 'http://127.0.0.1:3000/users/updateMe';
          _context.next = 5;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var session, _err$response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          console.log("Booking tour: ".concat(tourId));
          _context.next = 4;
          return (0, _axios.default)("/bookings/checkout-session/".concat(tourId));
        case 4:
        ...
        case 13:
          _context.prev = 13;
          _context.t0 = _context["catch"](0);
          console.error("Payment error:", ((_err$response = _context.t0.response) === null || _err$response === void 0 ? void 0 : _err$response.data) || _context.t0);
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // /* eslint-disable */
// console.log("Hola")
// A function (from mapbox.js) that displays a map with locations.
// Ensure paystack.js is imported
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 9:
              _context2.prev = 9;
              _context2.next = 12;
              return (0, _paystack.bookTour)(tourId);
            case 12:
              _context2.next = 18;
              break;
            case 14:
              ...
              console.error("⚠️ Payment error:", _context2.t0);
              e.target.textContent = "Book tour now!";
            case 18:
            case "end":
              return _context2.stop();
